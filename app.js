...
function updateEquation(data) {
  ...
  els.darcyFrictionEquation.textContent = String.raw`\[f_{\mathrm{Darcy}}=\begin{cases}\displaystyle\frac{64}{\mathrm{Re}_{\mathrm{gen\,HBE}}},&\mathrm{Re}_{\mathrm{gen\,HBE}}\le 2100\quad(\text{laminar})\\[6pt]\displaystyle(1-w)\frac{64}{\mathrm{Re}_{\mathrm{gen\,HBE}}}+w\,f_{\mathrm{Darcy}}^{*},&2100<\mathrm{Re}_{\mathrm{gen\,HBE}}<3000\quad(\text{interpolação laminar--turbulenta}),\ w=\frac{\mathrm{Re}_{\mathrm{gen\,HBE}}-2100}{900}\\[6pt]\displaystyle\frac{1}{\sqrt{f_{\mathrm{Darcy}}}}=\frac{2}{m^{0{,}75}}\log_{10}\!\left[\mathrm{Re}_{\mathrm{gen\,HBE}}\left(\frac{f_{\mathrm{Darcy}}}{4}\right)^{1-m/2}\right]-\frac{0{,}2}{m^{1{,}2}},&\mathrm{Re}_{\mathrm{gen\,HBE}}\ge 3000\quad(\text{Dodge--Metzner})\end{cases}\]`;
